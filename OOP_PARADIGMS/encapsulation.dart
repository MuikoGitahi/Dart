//Encapsulation is the process of keeping a class' implementation details hidden from the user using an objects functions
/*
 It is achieved by:
  1.Declaring a class property as private using an underscor(_)
  2.Providing public Getter and Setter methods to access and update the value of a private property
